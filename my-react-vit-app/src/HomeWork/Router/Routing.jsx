  ...
  return (
    <Router>
      <div>
        <nav>
          <ul>
            <li><Link to="/" onClick={() => setState({ currentPage: 'Home' })}>Home</Link></li>
            <li><Link to="/about" onClick={() => setState({ currentPage: 'About' })}>About</Link></li>
            <li><Link to="/contact" onClick={() => setState({ currentPage: 'Contact' })}>Contact</Link></li>
          </ul>
        </nav>
